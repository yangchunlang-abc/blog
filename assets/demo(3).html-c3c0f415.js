...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在只需要 npm run start即可。<br></p>`,5);function p(v,b){const t=o("ExternalLinkIcon");return s(),d("div",null,[c,e("p",null,[n("现在我们可以使用"),e("a",m,[n("nodemon"),r(t)]),n("工具在启动项目后自动重启更改的项目。"),u]),_])}const x=a(l,[["render",p],["__file","demo(3).html.vue"]]);export{x as default};
