import{_ as e,o as i,c as n,e as s}from"./app-616de0f2.js";const a={},r=s(`<p>为了保证密码的安全性，不建议在数据库以明文的形式保存用户密码，推荐对密码进行 加密存储</p><ul><li>加密之后的密码，无法被逆向破解</li><li>同一明文密码多次加密，得到的加密结果各不相同，保证了安全性 在当前项目中，使用 <code>bcryptjs</code> 对用户密码进行加密</li></ul><h3 id="下载bcryptjs" tabindex="-1"><a class="header-anchor" href="#下载bcryptjs" aria-hidden="true">#</a> 下载bcryptjs</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i bcryptjs
